...
assert_contains "$notice" "Active Human Users" "print_license_notice: names the counted-user term"
assert_contains "$notice" "sign in" "print_license_notice: clarifies Active Human Users = people who sign in"
assert_contains "$notice" "bots, integrations, AI agents" "print_license_notice: clarifies bots/integrations/agents/guests don't count"
...
assert_contains "$notice" "LICENSE-FAQ.md" "print_license_notice: links the plain-English FAQ"
