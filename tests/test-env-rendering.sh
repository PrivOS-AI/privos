...
unset ADMIN_PASS MONGO_ROOT_PASSWORD RUSTFS_ROOT_PASSWORD RUSTFS_ACCESS_KEY RUSTFS_SECRET_KEY REG_TOKEN SANDBOX_API_KEY WEAVIATE_ROOT_KEY PRIVOS_DEPLOYMENT_ID VAPID_PUBLIC_KEY VAPID_PRIVATE_KEY VAPID_SUBJECT MONGO_ROOT_USER RUSTFS_ROOT_USER RUSTFS_BUCKET ADMIN_EMAIL
load_existing_env
...
unset ADMIN_PASS MONGO_ROOT_PASSWORD RUSTFS_ROOT_PASSWORD RUSTFS_ACCESS_KEY RUSTFS_SECRET_KEY REG_TOKEN SANDBOX_API_KEY WEAVIATE_ROOT_KEY PRIVOS_DEPLOYMENT_ID VAPID_PUBLIC_KEY VAPID_PRIVATE_KEY VAPID_SUBJECT MONGO_ROOT_USER RUSTFS_ROOT_USER RUSTFS_BUCKET ADMIN_EMAIL
generate_secrets
for v in ADMIN_PASS MONGO_ROOT_PASSWORD RUSTFS_ROOT_PASSWORD RUSTFS_ACCESS_KEY RUSTFS_SECRET_KEY REG_TOKEN SANDBOX_API_KEY PRIVOS_DEPLOYMENT_ID VAPID_PUBLIC_KEY VAPID_PRIVATE_KEY; do
  assert_true=1
  [[ -n "${!v:-}" ]] && assert_true=0
